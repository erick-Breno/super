...
export async function createProduct(productData) {
  try {
    const { name, description, price, promotional_price, category, image_url, featured, promotion } = productData

    const result = await sql`
      INSERT INTO products (name, description, price, promotional_price, category, image_url, featured, promotion)
      VALUES (${name}, ${description}, ${price}, ${promotional_price}, ${category}, ${image_url}, ${featured}, ${promotion})
      RETURNING *
    `
